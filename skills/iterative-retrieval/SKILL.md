...
# 反復検索パターン (Iterative Retrieval Pattern)
...
### フェーズ1: DISPATCH (The Solution: Iterative Retrieval)
...
### フェーズ2: EVALUATE (Phase 1: DISPATCH)
...
### 例1: バグ修正コンテキスト (Practical Examples)
...
### 例2: 機能実装 (Example 1: Bug Fix Context)
...
## エージェントとの統合 (Example 2: Feature Implementation)
...
## ベストプラクティス (Integration with Agents)
