---
name: brand-voice
description: 実投稿、エッセイ、ローンチノート、ドキュメント、サイトコピーからソース由来の文体プロファイルを構築し、コンテンツ・アウトリーチ・ソーシャルワークフローで再利用。汎用 AI 文体を避けた voice 一貫性が必要なとき。brand voice, content, outreach.
origin: ECC
---
...
## Affaan / ECC デフォルト (Affaan / ECC Defaults)
