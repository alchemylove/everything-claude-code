# HOOK-FIX-20260421 補遺 — v2.1.116 argv 重複バグ (HOOK-FIX-20260421 Addendum — v2.1.116 argv 重複バグ)
...
## Claude Code v2.1.116 の argv 重複バグ（詳細）(Claude Code v2.1.116 の argv 重複バグ（詳細）)
...
### Claude Code 側の挙動 (Claude Code 側の挙動)
